 ...
 * material：材质，
 * translucent 是否透明
 * vertexShaderSource 顶点着色器代码
 * fragmentShaderSource 片段着色器代码
 * renderState 渲染状态
 * 如果要自定义Appearance，一般要覆盖material、vertexShaderSource、fragmentShaderSource
 * 面：
 *      --PerInstanceColorAppearance
 *          --PerInstanceColorAppearanceFS/VS
 *          --PerInstanceFlatColorAppearanceFS/VS
 *      --MaterialAppeance
 *          --BasicMaterialAppearanceFS/VS
 *          --TexturedMaterialAppearanceFS/VS
 *          --AllMaterialAppearanceFS/VS
 * 线：
 *      --PolylineColorAppearance
 *          --PolylineColorAppearanceVS/PerInstanceFlatColorAppearanceFS
 *      --PolylineMaterialAppearance
 *          --PolylineMaterialAppearanceVS/PolylineFS
 */
